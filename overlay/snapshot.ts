...
async function buildEmbeddedFontFaceCss(families: Iterable<string>): Promise<string> {
...
async function getEmbeddedFontFaceCss(families: Iterable<string>): Promise<string> {
